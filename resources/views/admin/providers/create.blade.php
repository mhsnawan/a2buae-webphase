    ...
    <div class="container-fluid">
    	<div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{route('admin.provider.store')}}" method="POST" enctype="multipart/form-data" role="form">
				...
				<div class="form-group row">
					<label for="emirates_id" class="col-xs-12 col-form-label">Emirates ID</label>
					<div class="col-xs-10">
						<input class="form-control" type="text" value="{{ old('emirates_id') }}" name="emirates_id" required id="emirates_id" placeholder="Emirates ID">
					</div>
				</div>

				<div class="form-group row">
					<label for="license_type" class="col-xs-12 col-form-label">License Type</label>
					<div class="col-xs-10">
						<select class="form-control" id="calculator" name="license_type">
				...
				<div class="form-group row">
					<label for="license_id" class="col-xs-12 col-form-label">License ID</label>
					<div class="col-xs-10">
						<input class="form-control" type="text" value="{{ old('license_id') }}" name="license_id" required id="license_id" placeholder="License ID">
					</div>
				</div>

				
				<div class="form-group row">
					<label for="license_id" class="col-xs-12 col-form-label">License Expiry</label>
					<div class="col-xs-10">
						<input class="form-control" type="date" value="{{ old('license_expiry') }}" name="license_expiry" required id="license_expiry" placeholder="License Expiry">
					</div>
				</div>

				<div class="form-group row">
					<label for="assign_vechile_type" class="col-xs-12 col-form-label">Assign Vechile Type</label>
					<div class="col-xs-10">
						<select class="form-control" id="calculator" name="assign_vechile_type">
