...
<div class="col-lg-6">
    <div class="row row-md mb-2">
		...
		<div class="col-lg-4 col-md-6 col-xs-12">
			<div class="box3 box-block bg-white tile tile-1 mb-2">
			<img src="https://portal.a2buae.com/main/assets/img/1.png" 
			     class="img-responsive center2" alt="img">
				<div class="t-content">
		...
		<div class="col-lg-4 col-md-6 col-xs-12">
			<div class="box3 box-block bg-white tile tile-1 mb-2">
				<img src="https://portal.a2buae.com/main/assets/img/2.png" 
			     class="img-responsive center2" alt="img">
				<div class="t-content">
		...
		<div class="col-lg-4 col-md-6 col-xs-12">
			<div class="box3 box-block bg-white tile tile-1 mb-2">
				<img src="https://portal.a2buae.com/main/assets/img/3.png" 
			     class="img-responsive center2" alt="img">
				<div class="t-content">
	...
	<div class="row row-md">
	    <div class="col-lg-4 col-md-6 col-xs-12">
			<div class="box3 box-block bg-white tile tile-1 mb-2">
				<img src="https://portal.a2buae.com/main/assets/img/4.png" 
			     class="img-responsive center2" alt="img">
				<div class="t-content">
		...
		<div class="col-lg-4 col-md-6 col-xs-12">
			<div class="box3 box-block bg-white tile tile-1 mb-2">
				<img src="https://portal.a2buae.com/main/assets/img/5.png" 
			     class="img-responsive center2" alt="img">
				<div class="t-content">
		...
		<div class="col-lg-4 col-md-6 col-xs-12">
			<div class="box3 box-block bg-white tile tile-1 mb-2">
				<img src="https://portal.a2buae.com/main/assets/img/6.png" 
			     class="img-responsive center2" alt="img">
				<div class="t-content">
...
<div class="col-lg-6">
    <h5 class="float-xs-left mb-2">Recent Rides</h5>
	<div class="row row-md mb-2">
		<div class="col-md-12">
				<div class="box bg-white">
					<div class="box-block clearfix">
						<h4 class="float-xs-left">Ride’s History</h4>
