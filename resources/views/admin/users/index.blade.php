        ...
        <div class="box box-block bg-white">
            ...
            <table class="table table-striped table-bordered dataTable" id="table-2">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $index + 1 }}</td>
                        <!-- <td>{{ substr($user->first_name, 0, 1).str_repeat('*', strlen($user->first_name)) }}</td>
                        <td>{{ substr($user->last_name, 0, 1).str_repeat('*', strlen($user->last_name)) }}</td> -->
                        ...
                        <td>+919876543210</td>
                        @else
                        <td>{{  substr($user->mobile, 0, 3).str_repeat('*', strlen($user->mobile)) }}</td>
                        @endif
                        <td>{{ $user->rating }}</td>
