<div class="site-sidebar">
	<div class="custom-scroll custom-scroll-light">
		<ul class="sidebar-menu">
			...
			<li class="with-sub">
				<a href="{{ route('admin.dispatch-manager.index') }}" class="waves-effect  waves-light">
					<!--<span class="s-caret"><i class="fa fa-angle-down"></i></span>-->
					<span class="s-icon"><i class="ti-crown"></i></span>
			...
			<li class="with-sub">
				<a href="{{ route('admin.fleet.index') }}" class="waves-effect  waves-light">
					<!--<span class="s-caret"><i class="fa fa-angle-down"></i></span>-->
					<span class="s-icon"><i class="ti-crown"></i></span>
			...
			<li class="with-sub">
				<a href="{{ route('admin.account-manager.index') }}" class="waves-effect  waves-light">
					<!--<span class="s-caret"><i class="fa fa-angle-down"></i></span>-->
					<span class="s-icon"><i class="ti-crown"></i></span>
			...
			<li class="with-sub">
				<a href="{{ route('admin.document.index') }}" class="waves-effect  waves-light">
					<!--<span class="s-caret"><i class="fa fa-angle-down"></i></span>-->
			...
			<li class="with-sub">
				<a href="{{ route('admin.promocode.index') }}" class="waves-effect  waves-light">
					<!--<span class="s-caret"><i class="fa fa-angle-down"></i></span>-->
					<span class="s-icon"><i class="ti-layout-tab"></i></span>
